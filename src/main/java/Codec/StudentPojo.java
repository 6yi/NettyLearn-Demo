...
public final class StudentPojo {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NAM_FIELD_NUMBER = 2;
    private volatile Object nam_;
    /**
     * <code>string nam = 2;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!getNamBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 2, nam_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!getNamBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, nam_);
      }
  ...
  static {
    String[] descriptorData = {
      ...
      "\n\003nam\030\002 \001(\tB\rB\013StudentPojob\006proto3"
    };
